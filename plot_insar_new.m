function plot_insar_new(insarx, insary, insaru, block_size, look, ...
        x, y, u1d, u1d_LSQ, nanstat, radscale, grid_res, ...
        GPSNameList, optimizedM, coast_new, cLimits, opacity, saveFigs, demFile)
...
text(inax, tip_x-5.5e-3, tip_y, 'LoS', ... % change to + for desc
     'Color', 'k', ...
     'FontSize', 32, ...
...
inax.Position = pos;
set(gca, 'FontSize', 32,'XTickLabel', [], 'YTickLabel', []) % 'YTickLabel', []
