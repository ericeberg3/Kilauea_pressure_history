...
params = [ ...
    ...
    struct('file','Data/post_im/d_hmm_kyle.png',    'name','dcHMM',     'xlim',[-500, -2.5e3]);
    struct('file','Data/post_im/vol_hmm.png',  'name','volHMM',   'xlim',[0 12e9]); ...
    struct('file','Data/post_im/alpha_hmm.png', 'name','alphaHMM','xlim',[0.8 2.0]); ... %[1.6 1.8]
